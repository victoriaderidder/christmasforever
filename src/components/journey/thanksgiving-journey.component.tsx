...
export const ThanksgivingJourney = [
  ...
  <Story story={`Hundreds of years have passed since your last adventure.`} />,
  <Story
    story={`That adventure being, of course, the one where Santa was kidnapped!!!`}
  />,
  <Story story={`Surely you couldn't have forgotten such a glorious tale.`} />,
  <Story
  ...
  />,
  <Story story={`It took you a couple hundred years, but you finally did!`} />,
  <Story
  ...
  <Title title="> Santa Lizzy." />,
  <Story story={`You're grateful for 31 relaxing days until the big night.`} />,
  ...
  <Story story={`You've spent the past year hand carving it just for them.`} />,
  ...
  <Story story={`?`} />,
  <Title title="> GoodWill Toward Men." />,
  <Story story={`Santa Lizzy and La Befellena have vanished into thin air.`} />,
  ...
  <Story story={`You ask him where this advent calendar really came from.`} />,
  <Title title="> Elfward." />,
